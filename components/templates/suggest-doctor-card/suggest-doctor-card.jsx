   ...
   return (
      <div
         className="w-[89px] rounded-[9px] bg-white px-[7px] pb-[7px] pt-[10.5px] max-customMd:shrink-0
          customMd:w-[191px] customMd:rounded-[19px] customMd:px-[15px] customMd:pb-[15px] customMd:pt-[23px]"
      ...
      >
         ...
         <p className="mt-[9px] text-center text-[8px] text-[#404040] customMd:mt-[15px] customMd:text-15">
            دکتر سعیده برزین تند
         </p>
         <p className="mt-1 text-center text-[8px] text-[#40404080] customMd:mt-[11px] customMd:text-15">
            متخصص زنان زایمان
         </p>
         <div className="mt-[10px] flex items-center justify-between customMd:mt-[23px]">
            <p
             ...
             text-[6px] text-primaryBlue customMd:h-[34px] customMd:rounded-10 customMd:px-[15px] customMd:text-xs"
            >
               ۱۰۰۰+ مشاوره
            </p>
            <div

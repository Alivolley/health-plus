...
// MUI
import { Breadcrumbs, Button, TextField, useMediaQuery } from '@mui/material';
      ...
      <div className="px-eighteen pb-[200px] customMd:px-[90px]">
         <div className="mx-auto max-w-[1260px]">
            ...
            <div className="mt-5 max-customMd:rounded-[6px] max-customMd:bg-[#2ED7FE0D] max-customMd:px-8 customMd:mt-[30px]">
               ...
               <img src={isDesktop ? pharmacyBanner1.src : pharmacyBanner1Mobile.src} alt="banner" className="w-full" />
            </div>
